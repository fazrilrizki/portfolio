...
<div id="home" class="body flex items-center justify-center bg-gray-100 mt-20">
...
<script>
    var typed = new Typed(".auto-type", {
        strings : ["Fazril Rizki !", "A Programmer !"],
        typeSpeed : 150,
        backSpeed : 150,
        loop : true,
    })
